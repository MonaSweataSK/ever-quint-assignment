...
dragging to another column will update the task status.

We are using the library - hello-pangea/dnd for drag and drop because it is already used by Atlassion and it is mainly for lists and easier to setup
